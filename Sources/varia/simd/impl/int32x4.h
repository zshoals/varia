...
static inline varia_int32x4_t varia_int32x4_intrin_load(const int32_t *values) {
	return _mm_load_si128((const varia_int32x4_t *)values);
}

static inline varia_int32x4_t varia_int32x4_intrin_load_unaligned(const int32_t *values) {
	return _mm_loadu_si128((const varia_int32x4_t *)values);
}

static inline varia_int32x4_t varia_int32x4_load(const int32_t values[4]) {
	return _mm_set_epi32(values[3], values[2], values[1], values[0]);
}

static inline varia_int32x4_t varia_int32x4_load_all(int32_t t) {
	return _mm_set1_epi32(t);
}

static inline void varia_int32x4_store(int32_t *destination, varia_int32x4_t value) {
	_mm_store_si128((varia_int32x4_t *)destination, value);
}

static inline void varia_int32x4_store_unaligned(int32_t *destination, varia_int32x4_t value) {
	_mm_storeu_si128((varia_int32x4_t *)destination, value);
}

static inline int32_t varia_int32x4_get(varia_int32x4_t t, int index) {
	union {
		__m128i value;
		int32_t elements[4];
	} converter;
...
static inline varia_int32x4_t varia_int32x4_add(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_add_epi32(a, b);
}

static inline varia_int32x4_t varia_int32x4_sub(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_sub_epi32(a, b);
}

static inline varia_int32x4_t varia_int32x4_max(varia_int32x4_t a, varia_int32x4_t b) {
	__m128i mask = _mm_cmpgt_epi32(a, b);
	return _mm_xor_si128(b, _mm_and_si128(mask, _mm_xor_si128(a, b)));
}

static inline varia_int32x4_t varia_int32x4_min(varia_int32x4_t a, varia_int32x4_t b) {
	__m128i mask = _mm_cmplt_epi32(a, b);
	return _mm_xor_si128(b, _mm_and_si128(mask, _mm_xor_si128(a, b)));
}

static inline varia_int32x4_mask_t varia_int32x4_cmpeq(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_cmpeq_epi32(a, b);
}

static inline varia_int32x4_mask_t varia_int32x4_cmpge(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_or_si128(_mm_cmpgt_epi32(a, b), _mm_cmpeq_epi32(a, b));
}

static inline varia_int32x4_mask_t varia_int32x4_cmpgt(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_cmpgt_epi32(a, b);
}

static inline varia_int32x4_mask_t varia_int32x4_cmple(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_or_si128(_mm_cmplt_epi32(a, b), _mm_cmpeq_epi32(a, b));
}

static inline varia_int32x4_mask_t varia_int32x4_cmplt(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_cmplt_epi32(a, b);
}

static inline varia_int32x4_mask_t varia_int32x4_cmpneq(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_andnot_si128(_mm_cmpeq_epi32(a, b), _mm_set1_epi32(0xffffffff));
}

static inline varia_int32x4_t varia_int32x4_sel(varia_int32x4_t a, varia_int32x4_t b, varia_int32x4_mask_t mask) {
	return _mm_xor_si128(b, _mm_and_si128(mask, _mm_xor_si128(a, b)));
}

static inline varia_int32x4_t varia_int32x4_or(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_or_si128(a, b);
}

static inline varia_int32x4_t varia_int32x4_and(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_and_si128(a, b);
}

static inline varia_int32x4_t varia_int32x4_xor(varia_int32x4_t a, varia_int32x4_t b) {
	return _mm_xor_si128(a, b);
}

static inline varia_int32x4_t varia_int32x4_not(varia_int32x4_t t) {
...
static inline varia_int32x4_t varia_int32x4_shift_left(varia_int32x4_t t, const int shift) {
	varia_int32x4_t value;
...
static inline varia_int32x4_t varia_int32x4_shift_right(varia_int32x4_t t, const int shift) {
	varia_int32x4_t value;
	value.values[0] = t.values[0] >> shift;
	value.values[1] = t.values[1] >> shift;
	value.values[2] = t.values[2] >> shift;
