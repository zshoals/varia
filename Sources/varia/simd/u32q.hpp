...
VARIA_INLINE u32q u32q_set_all(u32 n) { return kinc_uint32x4_load_all(n); }
VARIA_INLINE u32 u32q_get(u32q n, int index) { return kinc_uint32x4_get(n, index); }
VARIA_INLINE u32q u32q_add(u32q a, u32q b) { return kinc_uint32x4_add(a, b); }
VARIA_INLINE u32q u32q_sub(u32q a, u32q b) { return kinc_uint32x4_sub(a, b); }
//No Multiply
//No Division
VARIA_INLINE u32q u32q_max(u32q a, u32q b) { return kinc_uint32x4_max(a, b); }
VARIA_INLINE u32q u32q_min(u32q a, u32q b) { return kinc_uint32x4_min(a, b); }
VARIA_INLINE u32q_mask u32q_cmpeq(u32q a, u32q b) { return kinc_uint32x4_cmpeq(a, b); }
VARIA_INLINE u32q_mask u32q_cmpneq(u32q a, u32q b) { return kinc_uint32x4_cmpneq(a, b); }
VARIA_INLINE u32q_mask u32q_cmpgt(u32q a, u32q b) { return kinc_uint32x4_cmpgt(a, b); }
VARIA_INLINE u32q_mask u32q_cmpgte(u32q a, u32q b) { return kinc_uint32x4_cmpge(a, b); }
VARIA_INLINE u32q_mask u32q_cmplt(u32q a, u32q b) { return kinc_uint32x4_cmplt(a, b); }
VARIA_INLINE u32q_mask u32q_cmplte(u32q a, u32q b) { return kinc_uint32x4_cmple(a, b); }
VARIA_INLINE u32q u32q_select(u32q a, u32q b, u32q mask) { return kinc_uint32x4_sel(a, b, mask); }
VARIA_INLINE u32q u32q_or(u32q a, u32q b) { return kinc_uint32x4_or(a, b); }
VARIA_INLINE u32q u32q_and(u32q a, u32q b) { return kinc_uint32x4_and(a, b); }
VARIA_INLINE u32q u32q_xor(u32q a, u32q b) { return kinc_uint32x4_xor(a, b); }
VARIA_INLINE u32q u32q_not(u32q n) { return kinc_uint32x4_not(n); }
